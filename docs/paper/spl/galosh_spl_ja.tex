...
~\cite{alleysson}の見方の系譜）、各クワッドの $2{\times}2$ Walsh--Hadamard
変換で\emph{厳密に}分離する --- これにより 2 種類のノイズ集団を、いかなる
...
1 つのフル解像度輝度プレーンと 3 つの半解像度色差プレーンへ分離する ---
直交かつ厳密可逆な分解であり、補間は一切介在しない。色差は半解像度
