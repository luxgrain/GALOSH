...
\texttt{https://github.com/luxgrain/GALOSH}.}}
...
The manuscript text was drafted with the assistance of Anthropic's Claude
large language models (Claude Opus 4.7/4.8 and Claude Fable 5) under the
author's direction, and the reference implementation was developed with the
same AI assistance (documented per-commit in the public repository history).
The method, experiments, and all claims were designed, verified, and
