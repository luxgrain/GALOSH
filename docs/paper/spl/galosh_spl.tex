...
CFA analysis~\cite{alleysson}, and demultiplexes it \emph{exactly} with a
$2{\times}2$ Walsh--Hadamard transform of each quad --- so the two noise
...
Walsh--Hadamard transform demultiplexes each Bayer quad into one
full-resolution luminance plane and three half-resolution chroma planes ---
an orthogonal, exactly invertible decomposition; no interpolation is
involved. Chroma is denoised at
