...
__kernel void k_p10_reconstruct(__global const int *c1a, __global const int *c2a,
                                __global const int *c3a, __global const int *L_pixel,
                                __global int *out, int width, int height,
