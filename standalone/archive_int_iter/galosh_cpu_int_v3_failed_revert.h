...
/* LUT size: 4096 entries (v12 baseline).  Tried 1024 in v13 cleanup but
 * RawNIND aggregate regressed -1 dB (more diverse content needs finer LUT
 * precision than SIDD).  Reverted to 4096 to preserve v12 quality. */
#define FXP_GAT_INV_TABLE_SIZE 4096
