/* galosh_core.h  --  GALOSH CPU-side complete library  (darktable plugin) (algorithm core +
 ...
 *
 * RAW pipeline orchestration lives in rawdenoise_galosh.h (self-contained
 * darktable IOP).  YUV pipeline orchestration lives in galosh_yuv.c.
 */
