...
\quad \textbf{GALOSH-YUV（提案）} & \textbf{35.01} & \textbf{0.838} & \textbf{0.314} & \textbf{0.243} & \underline{5.41} & 2.50 & 0.87\\
...
発散（生出力 $\pm10^3$、該当シーンの PSNR\,$<$\,5）。発散シーンを除外した平均
...
ケース（表~\ref{tab:rawnind_srgb}）はこの帯に含まれる。}
\end{table}
